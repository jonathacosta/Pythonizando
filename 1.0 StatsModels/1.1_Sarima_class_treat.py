...
class treatment():
    def __init__(self,dataset):
        '''
        Método init da classe treatment recebe um dataset no formato csv.
        Admite que a coluna 0 contém as datas, estima o formato de datas de a frequencia do dataset
        '''
        try:
            ...
            try:
                ...
                print('-'*70 +'\nFalha num dos parâmetros do dataset ou no método __init__!\nAnalise-o diretamente na base de dados \n' + '-'*70)
                print('\n\n')
            else:
              ...
              print('-'*75,"\nDataset concatenado com totais diários! Aplicado: resample('D').sum().\n",'-'*75)
              print(self.df.head())
class states_graf():   
    ...
    def __init__(self,dataset):
        treatment.__init__(self,dataset)
    ...
    def states_graf(self,df):     
        ...
        plt.show()           
class sarima(states_graf):
        
    ''' Class métodos contém os métodos ARIMA, SARIMA e outros'''
    def __init__(self,dataset):
        states_graf.__init__(self,dataset)            
