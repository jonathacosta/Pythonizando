...
knn = KNeighborsClassifier(n_neighbors=2)   # Classificador
...
n=20
parametros = {
    'n_neighbors': list(range(1,n+1))
              }
grid = GridSearchCV(knn, cv=2, n_jobs=1, param_grid = parametros, scoring='accuracy')
